...
class FakePersonGeneratorTest {
  ...
  void generatePhoneReturnsValidPhone() {
    ...
    boolean mandatoryInitials =
        PHONE_PREFIXES_REQUIREMENT.stream().anyMatch(prefix -> phone.startsWith(prefix));
  ...
  private static final List<String> PHONE_PREFIXES_REQUIREMENT =
      List.of(
